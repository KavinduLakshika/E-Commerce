...
CREATE TABLE IF NOT EXISTS `ecommerce`.`customer` (
  ...
  `cusGender` VARCHAR(45) NOT NULL,
  `cusPhone1` VARCHAR(45) NOT NULL,
  `cusPhone2` VARCHAR(45) NULL,
  `cusCountry` VARCHAR(45) NOT NULL,
  `cusDob` VARCHAR(45) NOT NULL,
  `cusImg` VARCHAR(45) NULL,
  `cusPostalCode` VARCHAR(255) NOT NULL,
  `cusStatus` VARCHAR(255) NULL,
  `delivery_deliveryId` INT NOT NULL,
  PRIMARY KEY (`cusId`),
  INDEX `fk_customer_delivery1_idx` (`delivery_deliveryId` ASC),
  CONSTRAINT `fk_customer_delivery1`
...
CREATE TABLE IF NOT EXISTS `ecommerce`.`product` (
  ...
  `productDiscription` VARCHAR(255) NULL,
